...
#endif
static const char *ng0 = "D:/Tasks/Beihang University/HW/Beihang-University/computer_organization/p4/p4_cpu/ifu.v";
...
LAB60:    t165 = ((char*)((ng1)));
    ...
    *((unsigned int *)t166) = (t174 & 67108863U);
    t175 = *((unsigned int *)t167);
    *((unsigned int *)t167) = (t175 & 67108863U);
    t177 = (t0 + 1060U);
    t178 = *((char **)t177);
    memset(t176, 0, 8);
    t177 = (t176 + 4);
    ...
    *((unsigned int *)t177) = (t185 & 15U);
    xsi_vlogtype_concat(t164, 32, 32, 3U, t176, 4, t166, 26, t165, 2);
    goto LAB61;
...
LAB80:    if (*((unsigned int *)t217) > 0)
        goto LAB81;

LAB82:    if (*((unsigned int *)t191) > 0)
        goto LAB83;

LAB84:    memcpy(t190, t227, 8);

LAB85:    goto LAB63;

LAB64:    xsi_vlog_unsigned_bit_combine(t134, 32, t164, 32, t190, 32);
    goto LAB68;

LAB66:    memcpy(t134, t164, 8);
    goto LAB68;
...
LAB87:    *((unsigned int *)t230) = 1;

LAB89:    memset(t246, 0, 8);
    t247 = (t230 + 4);
...
LAB95:    memcpy(t267, t246, 8);

LAB96:    memset(t228, 0, 8);
    t299 = (t267 + 4);
...
LAB107:    t306 = (t228 + 4);
    t307 = *((unsigned int *)t228);
    t308 = *((unsigned int *)t306);
    t309 = (t307 || t308);
    if (t309 > 0)
        goto LAB108;

LAB109:    t316 = *((unsigned int *)t228);
    t317 = (~(t316));
...
LAB111:    if (*((unsigned int *)t306) > 0)
        goto LAB112;

LAB113:    if (*((unsigned int *)t228) > 0)
        goto LAB114;

LAB115:    memcpy(t227, t321, 8);

LAB116:    goto LAB80;

LAB81:    xsi_vlog_unsigned_bit_combine(t190, 32, t222, 32, t227, 32);
    goto LAB85;

LAB83:    memcpy(t190, t222, 8);
    goto LAB85;
...
LAB108:    t310 = (t0 + 1060U);
    t311 = *((char **)t310);
    t310 = ((char*)((ng2)));
    memset(t312, 0, 8);
    xsi_vlog_unsigned_add(t312, 32, t311, 32, t310, 32);
    t313 = (t0 + 784U);
    t314 = *((char **)t313);
    memset(t315, 0, 8);
    xsi_vlog_unsigned_add(t315, 32, t312, 32, t314, 32);
    goto LAB109;

LAB110:    t313 = (t0 + 1060U);
    t320 = *((char **)t313);
    t313 = ((char*)((ng2)));
    memset(t321, 0, 8);
    xsi_vlog_unsigned_add(t321, 32, t320, 32, t313, 32);
    goto LAB111;

LAB112:    xsi_vlog_unsigned_bit_combine(t227, 32, t315, 32, t321, 32);
    goto LAB116;

LAB114:    memcpy(t227, t315, 8);
    goto LAB116;

}


extern void work_m_00000000000728087314_3146453351_init()
{
	static char *pe[] = {(void *)Cont_67_0};
	xsi_register_didat("work_m_00000000000728087314_3146453351", "isim/mipstb_isim_beh.exe.sim/work/m_00000000000728087314_3146453351.didat");
