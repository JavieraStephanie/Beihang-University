...
#endif
static const char *ng0 = "D:/Tasks/Beihang University/HW/Beihang-University/computer_organization/p6/p6_cpu/alu.v";
static int ng1[] = {32, 0};
static int ng2[] = {31, 0};
static int ng3[] = {0, 0};
static int ng4[] = {1, 0};
...
{
	static char *pe[] = {(void *)Always_50_0,(void *)Cont_71_1};
