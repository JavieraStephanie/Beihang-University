...
public class test {
	...
	public static void main(String[] args) {
		...
		code continue
		*/
		CreditCardAccount c1 = new CreditCardAccount("03","testcredit1","123");
		accountset.insert(c1);
		CreditCardAccount c2 = new CreditCardAccount("04","testcredit2","123");
		...
		DebitCardAccount d1 = new DebitCardAccount("05","testdebit1","123");
		accountset.insert(d1);
		DebitCardAccount d2 = new DebitCardAccount("06","testdebit2","123");
		...
		Account a3=new Account("07","maltese","123");
